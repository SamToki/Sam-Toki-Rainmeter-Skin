...
皮肤包及其内容物遵循 [GNU GPL v3 软件开源协议](https://www.gnu.org/licenses/gpl-3.0.en.html)。文档保留版权。<br>
The skin pack and its contents are released under the [GNU GPL v3 open source license](https://www.gnu.org/licenses/gpl-3.0.en.html). The documents are copyrighted.
